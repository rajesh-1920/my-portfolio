...
const App = (() => {
     ...
     */
    const startup = () => {
        console.log('%cPortfolio App Started', 'color: #00ff88; font-size: 14px; font-weight: bold;');
    ...
    const logWelcome = () => {
        ...
        console.log('%cBuilt with HTML5, CSS3 & Vanilla JavaScript\n%cCheck out the source code on GitHub → https://github.com', styles.text, styles.text);
